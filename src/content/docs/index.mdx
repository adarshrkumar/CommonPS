...
hero:
    ...
    actions:
        ...
        link: https://marketplace.visualstudio.com/items?itemName=adarshrkumar.pscode
        icon: vscode
---
...
<CardGrid>
    ...
    <Card title="VSCode Extension" icon="vscode">
        Syntax highlighting available through our [VSCode extension](https://github.com/adarshrkumar/commonps-syntax-highlighter).
    </Card>
</CardGrid>
